...
public class EditerEvenementController implements Initializable {
...
// For example, if you have a VBox layout, you can add the ImageView like this:
    ...
    public void saveEvenement(ActionEvent actionEvent) {
        ...
        serviceEvenement.modifierEvenement(event);
...
ev=event;
        fxNom.setText(event.getNom());
        fxDescription.setText(event.getDescription());
        fxLieu.setText(event.getLieu());
        fxImage.setText(event.getImage());
        java.sql.Date date = (java.sql.Date) event.getDate_evenement();
        java.util.Date utilDate = new java.util.Date(date.getTime());
        LocalDate localDate = utilDate.toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
        fxDate.setValue(localDate);
